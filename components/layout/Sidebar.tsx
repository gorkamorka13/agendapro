...
export default function Sidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <div className={`
      fixed inset-y-0 left-0 z-50 w-64 bg-slate-800 dark:bg-slate-950 text-slate-300 p-4 flex flex-col h-screen transition-transform duration-300 ease-in-out
